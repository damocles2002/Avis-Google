...
// quand un nouvel avis est déposé.
// Déploiement : supabase functions deploy notifier
// ============================================================
...
Deno.serve(async (req) => {
  try {
    ...
    // Récupérer le nom + email du restaurant (avec service_role pour contourner RLS)
    ...
    await resend.emails.send({
      from: 'DAMAVIS <onboarding@resend.dev>',
      to: resto.email_patron,
